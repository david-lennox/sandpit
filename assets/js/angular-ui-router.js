...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory,           $locationProvider) {
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $location,   $urlRouter,   $browser) {
    ...
    $state = {
      ...
      $current: root,
      transition: null
>>>>>>> Nested Views with different animations - see stack-overflow question on this matter.
    };
...
=======
    ...
    $state.transitionTo = function transitionTo(to, toParams, options) {
      ...
      for (var l=keep; l<toPath.length; l++, state=toPath[l]) {
        locals = toLocals[l] = inherit(locals);
          // DW: state here is the new state (I think)
        resolved = resolveState(state, toParams, state===to, resolved, locals);
      }
...
function $ViewDirective(   $state,   $injector,   $uiViewScroll ) {
  ...
  var directive = {
    ...
    priority: 400,
    transclude: 'element',
    compile: function (tElement, tAttrs, $transclude, $rootScope) {
      return function (scope, $element, attrs) {
        var previousEl, currentEl, currentScope, latestLocals,
            onloadExp     = attrs.onload || '',
            autoScrollExp = attrs.autoscroll,
        ...
        function cleanupLastView(clonedElement) {
            if(clonedElement) clonedElement.attr("class", "form-view-slide-right");
            if(currentEl) currentEl.attr("class", "form-view-slide-right");
        ...
        function updateView(firstTime) {
          ...
          var clone = $transclude(newScope, function(clone) {
            renderer.enter(clone, $element, function onUiViewEnter() {
              ...
              //debugger; // from console do this: $(".animation-to-set").attr("class", "form-view-slide-right");
